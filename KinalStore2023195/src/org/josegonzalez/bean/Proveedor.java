...
public class Proveedor {
    ...
    public Proveedor(int codigoProveedor, String NITProveedor, String nombresProveedor, String apellidosProveedor, String direccionProveedor, String razonSocial, String contactoPrincipal, String paginaWeb) {
    ...
    public String toString(){
        return getCodigoProveedor() + " | " + getNombresProveedor() + ", " + getApellidosProveedor();
    }        
}
